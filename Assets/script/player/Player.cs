...
public class Player : MonoBehaviour
{
    ...
    public void Movement()
    {
        ...
        if (Input.GetButtonDown("Jump") && Mathf.Abs(rb.velocity.y) < 0.1f) rb.velocity = new Vector2(rb.velocity.x, jumpForce);
        animator.SetFloat("yVelocity", rb.velocity.y);
        if (Mathf.Abs(rb.velocity.y) > 0.1f) animator.SetBool("IsGrounded", false);
    ...
    public Rigidbody2D getRB()
    {
        ...
        else return this.GetComponent<Rigidbody2D>();
    }
